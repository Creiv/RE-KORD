export const IT: Record<string, string> = {
  ...
  "nebula.hint": "Trascina per esplorare · rotella per zoom · clic su una stella, poi play o radio",
  "nebula.hintShort": "Tocca per selezionare · pinch per zoom · play o radio per ascoltare",
  ...
  "settings.libraryProbeEmptyConfirm":
    "Nella cartella scelta non risultano brani audio. Salvare comunque e ricaricare con libreria vuota?",
  "dashboard.smartRadioRandom": "Casuale",
  "dashboard.smartRadioRandomAllExcluded":
    "Nessun brano disponibile: tutti i brani sono esclusi dalla riproduzione casuale.",
  ...
  "library.selectionEmptyHint":
    "Questo account non ha ancora contenuti selezionati. Aggiungi artisti o album dalla sezione Scopri (Studio), oppure chiedi all'amministratore.",
  ...
  "settings.networkPublicIpHint": "IP pubblico del server: {{ip}}",
  "settings.networkPublicIpLoading": "Ricerca IP pubblico del server…",
  "settings.networkPublicIpUnavailable":
    "IP pubblico del server non disponibile (nessuna uscita verso internet o timeout).",
  ...
  "settings.remoteStartingHint":
    "Connessione a Cloudflare in corso… il QR compare appena cloudflared restituisce l’URL.",
  ...
  "settings.shortcutSeekDesc": "−15 s / +15 s sulla traccia in corso",
  "settings.shortcutListenDesc": "vai alla scheda Ascolta",
  "settings.shortcutPlectrDesc": "apri Plectr",
  "settings.shortcutNebulaDesc": "apri Nebula a schermo intero",
  ...
  "themePicker.customBgSizeErr": "File troppo grande (max {maxMb} MB). Prova una GIF più piccola o converti in WebP.",
  "themePicker.customBgExtract": "Estrai colori dall'immagine",
  "themePicker.customBgExtractBusy": "Analisi…",
  "themePicker.customBgExtractErr": "Impossibile analizzare l'immagine.",
