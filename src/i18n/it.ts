export const IT: Record<string, string> = {
  ...
  "trackMeta.fieldGenreSearchPlaceholder": "Cerca o scrivi un genere…",
  "trackMeta.fieldGenreNewPlaceholder": "Genere nuovo…",
  "trackMeta.fieldGenreAdd": "Aggiungi genere",
  "trackMeta.fieldGenreNoMatch": "Nessun genere in libreria corrisponde — usa + per aggiungerne uno nuovo",
  "trackMeta.fieldGenreListEmpty": "Nessun altro genere in libreria da aggiungere",
  ...
  "nebula.eyebrow": "Mappa stellare",
  "nebula.title": "Nebula",
  "nebula.lead": "{{n}} brani mappati per tempo ed energia — la tua libreria come costellazione vivente.",
  "nebula.empty": "Aggiungi brani alla libreria per accendere la nebula.",
  "nebula.searchPlaceholder": "Filtra stelle…",
  "nebula.resetView": "Ripristina vista",
  "nebula.allMoods": "Tutti i mood",
  "nebula.play": "Riproduci",
  "nebula.radioHere": "Radio qui",
  "nebula.openInLibrary": "In libreria",
  "nebula.hint": "Trascina per esplorare · rotella per zoom · clic su una stella per ascoltare · Shift+clic per radio locale",
  "nebula.hintShort": "Tocca per selezionare · pinch per zoom · play per ascoltare",
  "nebula.filters": "Filtri",
  "nebula.legendCenter": "Centro · calma",
  "nebula.legendEdge": "Bordo · energia",
  "nebula.legendAngle": "Angolo · tempo (BPM)",
  "nebula.surprise": "Sorprendimi",
  "nebula.expand": "Schermo intero",
  "nebula.collapse": "Esci da schermo intero",
  "nebula.energy": "energia",
  "nebula.favorite": "Preferito",
  "nebula.fog.unlabeled": "Senza mood",
  "nebula.dashboardEyebrow": "NEBULA",
  "nebula.dashboardTitle": "L'universo della tua musica",
  "nebula.dashboardOpen": "Apri nebula",
  "nebula.dashboardLead":
    "Ogni brano diventa una stella. BPM sull'asse orizzontale, energia su quello verticale — le nebulose colorate rivelano i cluster di mood della tua collezione.",
  "nebula.dashboardBullet1": "Esplora migliaia di brani con pan e zoom",
  "nebula.dashboardBullet2": "Avvia una radio intelligente da qualsiasi cluster",
  "nebula.dashboardBullet3": "Usa il BPM di Plectr quando disponibile, altrimenti mood e generi",
  "nebula.dashboardCta": "Entra nella nebula",
  "dashboard.smartRadioEyebrow": "Smart Radio",
  "dashboard.smartRadioHeading": "Ascolto veloce",
  "dashboard.smartRadioEmpty":
    "Ascolta qualcosa o aggiungi preferiti per popolare questa sezione.",
  "dashboard.smartRadioRandom": "Casuale",
  "dashboard.smartRadioPlayTrack": "Avvia radio da {{title}}",
  ...
  "listen.sleepTimer": "Timer spegnimento",
  "listen.sleepTimerAria": "Timer spegnimento audio",
  "listen.sleepTimerCancel": "Annulla",
  "listen.sleepTimerPresets": "Durate rapide",
  "listen.sleepTimerCustom": "Durata personalizzata",
  "listen.sleepTimerCustomShort": "Altro",
  "listen.sleepTimerHours": "Ore",
  "listen.sleepTimerHoursShort": "h",
  "listen.sleepTimerMinutes": "Minuti",
  "listen.sleepTimerMinutesShort": "min",
  "listen.sleepTimerStart": "Avvia",
  "listen.sleepTimerInvalid": "Inserisci da 1 minuto a 12 ore.",
  ...
  "library.browseLibrarySectionsAria": "Navigazione: artisti, generi, mood o nebula",
  ...
  "settings.nativePlayback":
    "Riproduzione nativa (APK Android, sperimentale)",
  "settings.nativePlaybackHint":
    "Usa ExoPlayer al posto del motore web. Il crossfade è disattivato. In caso di errore torna all'audio web.",
  "player.sleepTimer": "Timer spegnimento",
  "player.sleepTimerOff": "Spento",
  "player.sleepTimer15": "15 minuti",
  "player.sleepTimer30": "30 minuti",
  "player.sleepTimer60": "1 ora",
  ...
  "entityInfo.button": "Curiosità",
  "entityInfo.buttonTitle": "Leggi info e curiosità",
  "entityInfo.artistEyebrow": "Curiosità sull'artista",
  "entityInfo.albumEyebrow": "Curiosità sull'album",
  "entityInfo.close": "Chiudi",
  ...
  "player.radioFromTrackTitle": "Radio da questo brano",
  "player.radioFromTrackAria": "Sostituisci il resto della coda con una radio da questo brano",
  ...
  "player.castActive": "In trasmissione",
  "player.castUnavailable": "Cast non disponibile (usa Chrome in LAN)",
  ...
  "tools.einfoLabel": "Info e curiosità",
  "tools.einfoHint":
    "Cerca sul web più voci di curiosità e racconti nella lingua dell'app; apri le righe, spunta solo quelle che ti interessano (testo modificabile) e salva: compariranno col pulsante «Curiosità» in libreria.",
  "tools.einfoKindTrivia": "curiosità",
  "tools.einfoKindBio": "biografia",
  "tools.einfoKindDesc": "descrizione",
  "tools.einfoFoundCount": "{{n}} trovate",
  "tools.einfoPickedCount": "{{n}} scelte",
  "tools.einfoSavedCount": "{{n}} salvate",
  "tools.einfoSavedList": "Già salvate",
  "tools.einfoFoundList": "Trovate",
  "tools.einfoRemoveItem": "Rimuovi questa voce",
  "tools.einfoDupSaved": "già salvata",
  "tools.einfoScopeAria": "Ambito ricerca info",
  "tools.einfoScopeArtist": "Artista (tutti gli album)",
  "tools.einfoScopeAlbums": "Album selezionati",
  "tools.einfoSearch": "Cerca info",
  "tools.einfoSearching": "Ricerca…",
  "tools.einfoNoResults": "Nessun risultato trovato.",
  "tools.einfoSaveSelected": "Salva le voci scelte",
  "tools.einfoArtistRow": "Artista — {{name}}",
