export const EN: Record<string, string> = {
  ...
  "nebula.hint": "Drag to explore · scroll to zoom · click a star, then play or radio",
  "nebula.hintShort": "Tap to select · pinch to zoom · play or radio to listen",
  ...
  "settings.libraryProbeEmptyConfirm":
    "No audio tracks were found in the selected folder. Save anyway and reload with an empty library?",
  "dashboard.smartRadioRandom": "Random",
  "dashboard.smartRadioRandomAllExcluded":
    "No tracks available: every track is excluded from random playback.",
  ...
  "library.selectionEmptyHint":
    "This account has no selected content yet. Add artists or albums from the Discover section (Studio), or ask the administrator.",
  ...
  "settings.shortcutSeekDesc": "−15 s / +15 s on current track",
  "settings.shortcutListenDesc": "go to Listen",
  "settings.shortcutPlectrDesc": "open Plectr",
  "settings.shortcutNebulaDesc": "open Nebula in fullscreen",
  ...
  "themePicker.customBgSizeErr": "File too large (max {maxMb} MB). Try a smaller GIF or convert to WebP.",
  "themePicker.customBgExtract": "Extract colors from image",
  "themePicker.customBgExtractBusy": "Analyzing…",
  "themePicker.customBgExtractErr": "Could not analyze this image.",
