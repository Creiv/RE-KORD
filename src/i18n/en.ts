export const EN: Record<string, string> = {
  ...
  "sync.activity.pruningTrackMeta": "Cleaning library metadata…",
  ...
  "albumMeta.discogsCatalog": "Catalog no.",
  "albumMeta.discogsPrice": "Lowest price",
  "albumMeta.discogsCommunity": "Community",
  "albumMeta.discogsOpen": "Open on Discogs",
  ...
  "trackRow.addQueueTitle": "Play next",
  "trackRow.addQueueAria": "Play next",
  ...
  "library.albumInfoPresent": "Album metadata in database",
  "library.albumInfoMissing": "Album metadata not yet in the database",
  ...
  "nebula.eyebrow": "Star map",
  "nebula.title": "Nebula",
  "nebula.lead": "{{n}} tracks mapped by tempo and energy — your library as a living constellation.",
  "nebula.empty": "Add tracks to your library to light up the nebula.",
  "nebula.searchPlaceholder": "Filter stars…",
  "nebula.resetView": "Reset view",
  "nebula.allMoods": "All moods",
  "nebula.play": "Play",
  "nebula.radioHere": "Radio here",
  "nebula.openInLibrary": "In library",
  "nebula.hint": "Drag to explore · scroll to zoom · click a star to play · Shift+click for local radio",
  "nebula.hintShort": "Tap to select · pinch to zoom · play button to listen",
  "nebula.filters": "Filters",
  "nebula.legendCenter": "Center · calm",
  "nebula.legendEdge": "Edge · energy",
  "nebula.legendAngle": "Angle · tempo (BPM)",
  "nebula.surprise": "Surprise me",
  "nebula.expand": "Fullscreen",
  "nebula.collapse": "Exit fullscreen",
  "nebula.energy": "energy",
  "nebula.favorite": "Favorite",
  "nebula.fog.unlabeled": "Unlabeled",
  "nebula.dashboardEyebrow": "NEBULA",
  "nebula.dashboardTitle": "The universe of your music",
  "nebula.dashboardOpen": "Open nebula",
  "nebula.dashboardLead":
    "Every track becomes a star. BPM on the horizontal axis, energy on the vertical — colored nebulae reveal mood clusters in your collection.",
  "nebula.dashboardBullet1": "Pan and zoom through thousands of tracks at once",
  "nebula.dashboardBullet2": "Launch smart radio from any cluster",
  "nebula.dashboardBullet3": "Uses Plectr BPM when available, moods and genres otherwise",
  "nebula.dashboardCta": "Enter the nebula",
  "dashboard.smartRadioEyebrow": "Smart Radio",
  "dashboard.smartRadioHeading": "Quick listen",
  "dashboard.smartRadioEmpty":
    "Play something or add favorites to populate this section.",
  "dashboard.smartRadioRandom": "Random",
  "dashboard.smartRadioPlayTrack": "Start radio from {{title}}",
  ...
  "listen.sleepTimerCancel": "Cancel",
  "listen.sleepTimerPresets": "Quick durations",
  "listen.sleepTimerCustom": "Custom duration",
  "listen.sleepTimerCustomShort": "Other",
  "listen.sleepTimerHours": "Hours",
  "listen.sleepTimerHoursShort": "h",
  "listen.sleepTimerMinutes": "Minutes",
  "listen.sleepTimerMinutesShort": "min",
  "listen.sleepTimerStart": "Start",
  "listen.sleepTimerInvalid": "Enter between 1 minute and 12 hours.",
  ...
  "library.browseLibrarySectionsAria": "Browse artists, genres, moods, or nebula",
  ...
  "settings.integrationsHeading": "Integrations",
  "settings.integrationsReadOnly":
    "Remote view: manage these integrations only from the server PC (localhost).",
  "settings.discogsHeading": "Discogs",
  "settings.discogsLead":
    "Optional personal access token for richer metadata, artwork, and release details from Discogs.",
  "settings.discogsActive": "Token configured.",
  "settings.discogsHintNoToken":
    "Unauthenticated API: ~25 requests/min, no full artwork.",
  "settings.discogsHintWithToken":
    "Authenticated API: higher rate limits and full artwork access.",
  "settings.discogsMissing": "No Discogs token configured.",
  "settings.discogsEnvLocked":
    "Active from REKORD_DISCOGS_TOKEN: remove the environment variable to manage it in-app.",
  "settings.discogsReadOnly":
    "Remote view: the Discogs token can only be set on the server machine.",
  "settings.discogsTokenAria": "Discogs personal access token",
  "settings.discogsTokenPh": "Discogs token",
  "settings.discogsSave": "Save token",
  "settings.discogsClear": "Remove token",
  "settings.discogsTokenSaved": "Discogs token saved on the server.",
  "settings.discogsTokenCleared": "Discogs token removed.",
  ...
  "settings.nativePlayback":
    "Native playback (Android APK, experimental)",
  "settings.nativePlaybackHint":
    "Uses ExoPlayer instead of the browser engine. Crossfade is disabled. Falls back to web audio on error.",
  "player.sleepTimer": "Sleep timer",
  "player.sleepTimerOff": "Off",
  "player.sleepTimer15": "15 minutes",
  "player.sleepTimer30": "30 minutes",
  "player.sleepTimer60": "1 hour",
  ...
  "entityInfo.buttonTitle": "Read info & trivia",
  "entityInfo.artistEyebrow": "About the artist",
  "entityInfo.albumEyebrow": "About the album",
  "entityInfo.close": "Close",
  ...
  "statistics.overviewPlectrTracks": "Plectr tracks played",
  ...
  "player.radioFromTrackTitle": "Radio from this track",
  "player.radioFromTrackAria": "Replace the rest of the queue with radio from this track",
  ...
  "player.castActive": "Casting",
  "player.castUnavailable": "Cast unavailable (use Chrome on LAN)",
  ...
  "themePicker.customBgFitLabel": "Fit",
  "themePicker.customBgFitAria": "Background image fit",
  ...
  "tools.einfoLabel": "Info & trivia",
  "tools.einfoHint":
    "Search the web for multiple trivia entries in the app language; expand the rows, tick only the ones you care about (text is editable) and save: they will show up as the “Trivia” button in the library.",
  "tools.einfoKindTrivia": "trivia",
  "tools.einfoKindBio": "biography",
  "tools.einfoKindDesc": "description",
  "tools.einfoFoundCount": "{{n}} found",
  "tools.einfoPickedCount": "{{n}} picked",
  "tools.einfoSavedCount": "{{n}} saved",
  "tools.einfoSavedList": "Already saved",
  "tools.einfoFoundList": "Found",
  "tools.einfoRemoveItem": "Remove this entry",
  "tools.einfoDupSaved": "already saved",
  "tools.einfoScopeAria": "Info search scope",
  "tools.einfoScopeArtist": "Artist (all albums)",
  "tools.einfoScopeAlbums": "Selected albums",
  "tools.einfoSearch": "Find info",
  "tools.einfoSearching": "Searching…",
  "tools.einfoNoResults": "No results found.",
  "tools.einfoSaveSelected": "Save picked entries",
  "tools.einfoArtistRow": "Artist — {{name}}",
  ...
  "tools.scanAlbumsTitle":
    "Skip albums that already have metadata in the database; delay between requests (MusicBrainz rate limit)",
  "tools.tracks": "Tracks",
  "tools.currentTrackMeta": "Playing track metadata",
  "tools.selectedAlbumTracksMeta": "Selected album track metadata",
  "tools.metaAlbumTracksStart": "Fetching track metadata for album {{path}}…\n",
  "tools.metaAlbumTracksDone": "Album tracks: {{ok}} updated, {{err}} failed.\n",
  ...
  "tools.scanChoiceAlbumHint":
    "Fetch metadata only for albums missing metadata in the database, or rescan every album (refreshes existing metadata).",
  "tools.scanChoiceTrackTitle": "Scan all tracks",
  "tools.scanChoiceTrackHint":
    "Fetch metadata only for tracks missing genre or release date in the database, or rescan every audio file.",
  ...
  "tools.progressAlbumMeta": "Album metadata (Discogs / MB / TheAudioDB / iTunes)",
  "tools.discogsPickerTitle": "Choose Discogs release",
  "tools.discogsPickerHint":
    "Multiple editions were found. Pick the one that matches your files.",
  "tools.discogsPickerCancel": "Cancel",
  "tools.discogsCommunity": "Collection: {{have}} have · {{want}} want",
  "tools.metaDiscogsOkLine": "Discogs #{{id}} — {{path}} ({{date}}).\n",
  "tools.metaDiscogsFallback": "No Discogs results — falling back to MusicBrainz/TheAudioDB…\n",
  "tools.metaDiscogsFallbackErr": "Discogs unavailable ({{e}}) — falling back to other sources…\n",
  "tools.progressTrackMeta": "Track metadata",
  "tools.progressTrackMetaPrune": "Library metadata cleanup",
  "tools.trackMetaPruneOrphans": "Library metadata cleanup",
  "tools.trackMetaPruneTitle":
    "For each album: migrate useful metadata from JSON into SQLite, remove obsolete sidecars, stale keys, release tracklists, and track/disc numbers. Audio files are not modified. Album trivia (infoItems) stay in JSON.",
  "tools.trackMetaPruneConfirm":
    "Scan every album and clean up library metadata?\n\n• copy useful fields from kord-*.json into the database (missing fields only)\n• remove track sidecars and album metadata already in the DB\n• stale track entries with no matching audio file\n• release tracklists and track/disc numbers\n\nAudio files are not deleted.",
  "tools.trackMetaPruneStart":
    "Library metadata cleanup: {{n}} album folders.\n",
  "tools.trackMetaPruneAlbum": "  {{path}}: removed stale keys {{files}}\n",
  "tools.trackMetaPruneAlbumOrdering":
    "  {{path}}: cleared ordering fields on {{tracks}} track(s) · release tracklist: {{release}}\n",
  "tools.trackMetaPruneAlbumJson":
    "  {{path}}: migrated {{fields}} album field(s) and {{tracks}} track(s) from JSON · JSON files removed: {{files}}\n",
  "tools.trackMetaPruneDone":
    "Cleanup finished. Albums updated: {{a}} · stale keys: {{k}} · track ordering fields: {{o}} · release tracklists: {{e}} · album fields from JSON: {{f}} · tracks from JSON: {{t}} · JSON files removed: {{j}}.\n",
